                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        subtitle: const Text('NumConvert – Base Converter'),
                      ),
                      ListTile(
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('CodeByte Labs'),
                      ),
                      ListTile(
                        leading: const Icon(Icons.email_outlined),
                        title: const Text('Contact'),
                        subtitle: const Text('support@codebytelabs.com'),
                      ),
                      ListTile(
  ...
  void _showClearConfirmationDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Clear History?'),
        content: const Text(
          'This will permanently delete all your conversion history. '
